        ...
        <section
            ...
            <div
                ...
                <div className="flex justify-center">
                    <Link href={"/chi-siamo"}>
                        <button
                            className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-hidden hover:bg-indigo-600 rounded-sm text-lg">{t("header:chisiamo")}
                        </button>
                    </Link>
                    <Link href={"/contatti"}>
                        <button
                            className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-hidden hover:bg-gray-200 rounded-sm text-lg">{t("header:contattaci")}
                        </button>
                    </Link>
                </div>
            </div>
