    ...
    return (
        <header className="text-gray-600 body-font">
            ...
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <Link href={"/contatti"}>
                    <button
                        className="hidden lg:flex inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-hidden hover:bg-gray-200 rounded-sm text-base mt-4 md:mt-0">Contattaci
            ...
            {props.banner &&
                <div
                    ...
                    <span className="flex p-2 rounded-lg bg-indigo-800">
                        ...
                        <p className="ml-3 font-medium text-white">Il progetto Open The Data è in finale al Meet and Code Award</p>
                    </div>
